    ...
    <form method="POST" action="{{ route('activities.store') }}" id="activityForm">
                            ...
                            <select id="company_id" name="company_id"
                                ...
                                @foreach ($companies as $company)
                                    <option value="{{ $company->id }}"
                                        {{ old('company_id', $defaultCompanyId) == $company->id ? 'selected' : '' }}>
                                        {{ $company->name }}
                                    </option>
                                @endforeach
                            </select>
        ...
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body">
                ...
                <p class="text-muted small mb-0 mt-2" id="noAttachmentsMsg">
                    <i class="bi bi-info-circle me-1"></i> No attachments yet. Click "Add Image" or drag & drop to attach
                    photos.
                </p>
            </div>
        </div>
        ...
        <div class="d-flex justify-content-end gap-2 mb-4">
            <a href="{{ route('activities.index') }}" class="btn btn-light">Cancel</a>
