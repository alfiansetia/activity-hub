                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" id="additional_location" name="additional_location"
                            ...
                            placeholder="e.g. Meeting room, Lab, etc.">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="tests" name="tests" class="form-control @error('tests') is-invalid @enderror" rows="3"
                            placeholder="Describe the tests or criteria...">{{ old('tests', $activity->tests) }}</textarea>
                        @error('tests')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea id="ulasan" name="ulasan" class="form-control @error('ulasan') is-invalid @enderror" rows="3"
                            placeholder="Tulis ulasan atau review kegiatan...">{{ old('ulasan', $activity->ulasan) }}</textarea>
                        @error('ulasan')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
